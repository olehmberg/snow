		...
		webTables.foreach(new DataIterator<Table>() {
			...
			public void next(final Table t) {
				...
				try {
	    	    	 ...
	    	    	 ***********************************************/
					Map<Set<TableColumn>, Set<TableColumn>> functionalDependencies = FunctionalDependencyUtils.calculateFunctionalDependencies(t, f);
					...
					// Set<Set<TableColumn>> candKeysWithContext = FunctionalDependencyUtils.calculateUniqueColumnCombinations(t, f); 
					Set<Set<TableColumn>> candKeysWithContext = FunctionalDependencyUtils.listCandidateKeys(t);
