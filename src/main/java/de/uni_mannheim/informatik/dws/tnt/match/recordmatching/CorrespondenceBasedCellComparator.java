...
/**
 * Compares Web Table cells based on schema correspondences
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class CorrespondenceBasedCellComparator<DataType> implements Comparator<MatchableTableCell, MatchableTableColumn> {
	...
	public CorrespondenceBasedCellComparator(SimilarityMeasure<DataType> measure, KnowledgeBase kb) {
		this.measure = measure;
		this.kb = kb;
	}
	
	@Override
	public MatchableTableColumn getFirstSchemaElement(MatchableTableCell record) {
		// return Comparator.super.getFirstSchemaElement(record);
		return record.getColumn();
	}

	@Override
	public MatchableTableColumn getSecondSchemaElement(MatchableTableCell record) {
...
//	private static final Pattern numberingPattern = Pattern.compile("\\d*\\. (.+)");
	 ...
	 */
	@Override
	public double compare(MatchableTableCell record1, MatchableTableCell record2,
        ...
        // || !col1.equals(record1.getColumn()) || !col2.equals(record2.getColumn())) {
        //     return 0.0;
        // }

		Object value1 = record1.getValue();
		Object value2 = record2.getValue();
