 ...
 *
 */
public class RelationTableToKBVotingRule extends VotingMatchingRule<MatchableTableColumn, MatchableTableRow> {
	 ...
	 */
	public RelationTableToKBVotingRule(double finalThreshold, SimilarityMeasure<Double> numericSimilarity, SimilarityMeasure<LocalDateTime> dateSimilarity, SimilarityMeasure<String> stringSimilarity) {
