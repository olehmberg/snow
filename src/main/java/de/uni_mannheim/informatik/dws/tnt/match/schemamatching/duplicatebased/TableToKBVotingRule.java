 ...
 *
 */
public class TableToKBVotingRule extends VotingMatchingRule<MatchableTableColumn, MatchableTableRow> {
	 ...
	 */
	public TableToKBVotingRule(double finalThreshold, SimilarityMeasure<Double> numericSimilarity, SimilarityMeasure<LocalDateTime> dateSimilarity, SimilarityMeasure<String> stringSimilarity) {
